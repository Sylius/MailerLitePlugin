...
Base Sylius rules:
@see vendor/sylius/sylius/CLAUDE.md
...
### Core Structure
- **Main Plugin Class**: `src/SyliusMailerLitePlugin.php` - Entry point using `SyliusPluginTrait`
- **DI Extension**: `src/DependencyInjection/SyliusMailerLiteExtension.php` - Handles service loading and Doctrine migrations
